...
///
/// Note:
/// On linux, we use dbus to communicate multiple outerd process.
...
const DBUS_NAME: &str = "org.outerd.outerd";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "OuterD DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.outerd.outerd /dbus org.outerd.outerd.NewConnection string:'PEER_ID'`
