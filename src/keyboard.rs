...
// https://github.com/outerd/outerd/issues/8599
...
fn _map_keyboard_mode(_peer: &str, event: &Event, mut key_event: KeyEvent) -> Option<KeyEvent> {
    ...
    let keycode = match _peer {
        OS_LOWER_WINDOWS => {
            // https://github.com/outerd/outerd/issues/1371
...
// https://github.com/outerd/outerd/wiki/FAQ#keyboard-translation-modes
