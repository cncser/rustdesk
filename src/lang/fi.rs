...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään OuterD verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa OuterD ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi OuterDin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava OuterDille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava OuterDille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten OuterD daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota OuterDille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli OuterD ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "OuterD palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa OuterDin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "OuterD palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep OuterD background service", "Pidä OuterDin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista OuterDin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_outerd_password_tip", "Vahvista OuterD salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "OuterD ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_outerd_server_pro_to_{}_tip", "Päivitä OuterD Server Pro versioon {} jatkaaksesi."),
        ...
        ("About OuterD", "Tietoa OuterDistä"),
        ...
        ("upgrade_remote_outerd_client_to_{}_tip", "Päivitä etä-OuterD-asiakasversioon {} yhteensopivuuden takaamiseksi"),
