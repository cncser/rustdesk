...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem OuterD..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, OuterD v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate OuterDu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate OuterDu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno OuterDu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »OuterD Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep OuterD background service", "Ohrani OuterDovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije OuterD, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "OuterD potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "OuterD potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_outerd_password_tip", "Preveri geslo za OuterD"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite OuterD, prekinite klic in program zaprite."),
        ("scam_text2", "OuterD omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_outerd_server_pro_to_{}_tip", "Prosimo, nadgradite OuterD Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo OuterD"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno OuterDa odprto"),
        ...
        ("floating_window_tip", "Pomaga pri OuterD storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_outerd_client_to_{}_tip", "Prosimo, nadgradite OuterD odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
