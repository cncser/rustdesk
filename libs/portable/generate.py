...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("outerd".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../outerd-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\outerd\flutter\build\windows\runner\Debug\ -o . -e ..\outerd\flutter\build\windows\runner\Debug\outerd.exe
