...
class FfiModel with ChangeNotifier {
  ...
  bool shouldAutoRetryOnOffline(
    ...
    if (type == 'error' &&
      ...
      // https://github.com/outerd/outerd/discussions/14048
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsOuterDVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsOuterDVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsOuterDVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/outerd/outerd/pull/3706#issuecomment-1481242389
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get OuterDVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsOuterDVirtualDisplays] ?? []);
  ...
  bool get isOuterDIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'outerd_idd';
