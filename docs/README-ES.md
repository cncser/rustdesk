...
> Los desarrolladores de OuterD no aprueban ni apoyan ningún uso no ético o ilegal de este software. El mal uso, como el acceso no autorizado, el control o la invasión de la privacidad, va estrictamente en contra de nuestras directrices. Los autores no se hacen responsables de ningún uso indebido de la aplicación.

Chatea con nosotros: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/outerd) | [Reddit](https://www.reddit.com/r/outerd) | [YouTube](https://www.youtube.com/@outerd)

[![OuterD Server Pro](https://img.shields.io/badge/OuterD%20Server%20Pro-Caracter%C3%ADsticas%20Avanzadas-blue)](https://outerd.com/pricing.html)

Otro software de escritorio remoto, escrito en Rust. Funciona de forma inmediata, sin necesidad de configuración. Tienes el control total de tus datos, sin preocupaciones sobre la seguridad. Puedes utilizar nuestro servidor de rendezvous/relay, [instalar el tuyo](https://outerd.com/server), o [escribir tu propio servidor rendezvous/relay](https://github.com/outerd/outerd-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

OuterD agradece la contribución de todo el mundo. Lee [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) para ayuda para empezar.

[**¿Cómo funciona outerd?**](https://github.com/outerd/outerd/wiki/How-does-OuterD-work%3F)

[**DESCARGA DE BINARIOS**](https://github.com/outerd/outerd/releases)
...
Por favor, asegurate de que estás ejecutando estos comandos desde la raíz del repositorio de OuterD, de lo contrario la aplicación puede ser incapaz de encontrar los recursos necesarios. También ten en cuenta que otros subcomandos de cargo como `install` o `run` no estan actualmente soportados usando este metodo, ya que instalarían o ejecutarían el programa dentro del contenedor en lugar del host.

## Estructura de archivos

- **[libs/hbb_common](https://github.com/outerd/outerd/tree/master/libs/hbb_common)**:  codec de video, configuración, tcp/udp wrapper, protobuf, funciones para transferencia de archivos, y otras funciones de utilidad.
- **[libs/scrap](https://github.com/outerd/outerd/tree/master/libs/scrap)**: captura de pantalla
- **[libs/enigo](https://github.com/outerd/outerd/tree/master/libs/enigo)**: control del teclado/mouse especificos de cada plataforma
- **[src/ui](https://github.com/outerd/outerd/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/outerd/outerd/tree/master/src/server)**: sonido/portapapeles/input/servicios de video, y conexiones de red
- **[src/client.rs](https://github.com/outerd/outerd/tree/master/src/client.rs)**: iniciar una conexión "peer to peer"
- **[src/rendezvous_mediator.rs](https://github.com/outerd/outerd/tree/master/src/rendezvous_mediator.rs)**: Comunicación con [outerd-server](https://github.com/outerd/outerd-server), esperar la conexión remota directa ("TCP hole punching") o conexión indirecta ("relayed")
- **[src/platform](https://github.com/outerd/outerd/tree/master/src/platform)**: código específico de cada plataforma
- **[flutter](https://github.com/outerd/outerd/tree/master/flutter)**: Flutter, código para moviles
- **[flutter/web/js](https://github.com/outerd/outerd/tree/master/flutter/web/js)**: Javascript para el cliente web Flutter
