...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\OuterDPrinterDriver\\OuterDPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"OuterD Printer";
    LPCWCH RD_PRINTER_NAME = L"OuterD Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"OuterD v4 Printer Driver";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through OuterD Printer.
